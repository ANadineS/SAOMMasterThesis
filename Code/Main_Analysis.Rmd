...
```{r}
n <- 10
neg_error <- c(0.05, 0.1, 0.2, 0.3, 0.4)
pos_error <- c(0, 0.1)
...
saveRDS(random_output, "../Data/Output/01_Random_Raw_Output_Test.RData")
```

## Output Formatting
```{r}
random_output <- readRDS("../Data/Output/01_Random_Raw_Output_Test.RData")
...
random_results <- AnalyzeOutput(random_formatted, realmodel, n, error_combo)
```